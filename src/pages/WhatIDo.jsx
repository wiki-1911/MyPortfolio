...
import BookingCare1 from "../assets/images/bookingcare1.png";
import BookingCare2 from "../assets/images/bookingcare2.png";
import BookingCare3 from "../assets/images/bookingcare3.png";
import BookingCare4 from "../assets/images/bookingcare4.png";
import JiraHome from "../assets/images/JiraHome.png";
import Jira1 from "../assets/images/jira1.png";
import Jira2 from "../assets/images/jira2.png";
import Jira3 from "../assets/images/jira3.png";

export default function WhatIDo() {
  const bookingCareImage = [
    BookingCare,
    BookingCare1,
    BookingCare2,
    BookingCare3,
  ...
  const jiraImage = [JiraHome, Jira1, Jira2, Jira3];
  const [BookingCareImage, setBookingCareImage] = useState(0);
  const [jiRaImage, setjiraImage] = useState(0);

  useEffect(() => {
    const interval = setInterval(() => {
      setBookingCareImage((prev) => (prev + 1) % bookingCareImage.length);
      setjiraImage((prev) => (prev + 1) % jiraImage.length);
    }, 2000);
  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-10 space-y-12 text-center">
      ...
      >
        <Card className="relative shadow-lg border border-gray-200 hover:shadow-2xl transition-all duration-300 h-full flex flex-col">
          <div className="relative overflow-hidden rounded-t-2xl w-full h-64 md:h-72">
            <motion.img
              key={jiRaImage}
              src={jiraImage[jiRaImage]}
          ...
          <CardContent className="p-5 text-left">
            ...
            <br />
            <b className="text-black-600">Số thành viên: </b>{" "}
            <p className="pr-10 inline">3</p>
            <b className="text-black-600">Thời gian: </b> 02/09/2025 – Present
            <br /> <br />
            <div className="grid grid-cols-2 md:grid-cols-2 ">
              <span>
                <p className="text-black-600 mb-3">
                  Hệ thống quản lý dự án và tác vụ theo thời gian thực, tối ưu
                  hóa cộng tác nhóm, lập kế hoạch sprint linh hoạt, quản lý tác
                  vụ bằng giao diện kéo thả trực quan và chia sẻ tệp mượt mà nhờ
                  tích hợp Cloudinary, hỗ trợ snapshot.
                </p>
                <p className="text-black-600 mb-3">
              ...
              <span>
                <p className="text-black-600 mb-3 pl-10">
                  <b>Tính năng chính:</b>
                  <ul>
                    <li>
                      <IoIosAddCircle className="text-green-600 inline" /> Quản
                      lý vòng đời dự án toàn diện: Từ Backlog → Sprint → Nhiệm
                      vụ.
                    </li>
                    <li>
                    ...
                    <li>
                      <IoIosAddCircle className="text-green-600 inline" /> Hỗ
                      trợ tính năng quay lui (snapshot) để lưu trạng thái nhiệm
                      vụ.
                    </li>
                    <li>
            ...
            <div className="grid grid-cols-6 justify-center gap-2 mt-3 text-black-500">
              <div>
                <b>Frontend:</b>
              </div>
      ...
      >
        <Card className="relative shadow-lg border border-gray-200 hover:shadow-2xl transition-all duration-300 h-full flex flex-col">
          <div className="relative overflow-hidden rounded-t-2xl w-full h-64 md:h-72">
            <motion.img
              key={BookingCareImage}
              src={bookingCareImage[BookingCareImage]}
              alt="Project Management App"
              initial={{ x: 300, opacity: 0 }}
              animate={{ x: 0, opacity: 1 }}
              exit={{ x: -300, opacity: 0 }}
            ...
            <div className="grid grid-cols-2 md:grid-cols-2 ">
              <span>
                <p className="text-black-600 mb-3">
                  ...
                  lịch khám để hỗ trợ xây dựng chiến lược phát triển tương lai.
                  Hệ thống tích hợp thanh toán an toàn, đảm bảo trải nghiệm mượt
                  mà và đáng tin cậy.
                </p>
                <p className="text-black-600 mb-3">
                  Xây dựng API RESTful để quản lý thông tin người dùng, lịch hẹn
                  và hồ sơ bệnh án một cách hiệu quả. Tích hợp các cổng thanh
                  toán trực tuyến (VNPay và MoMo) cùng tính năng xác minh OTP
                  qua email, đảm bảo an toàn và bảo mật cho mọi giao dịch.
                </p>
              </span>
              <span>
                <p className="text-gray-600 mb-3 pl-10">
                  <b>Tính năng chính:</b>
                  <ul>
                    <li>
                    ...
                    <li>
                      ...
                      soát truy cập dựa trên vai trò (Quản trị viên, Bác sĩ,
                      Bệnh nhân).
                    </li>
                    <li>
